...
export class TaskService {
    ...
    private resourceUrl =  SERVER_API_URL + '/interactions/api/tasks';
    private resourceSearchUrl = SERVER_API_URL + '/interactions/api/_search/tasks';
    ...
    private convertItemFromServer(json: any): Task {
        ...
        entity.deadline = this.dateUtils
            .convertLocalDateFromServer(json.deadline);
        return entity;
    }
    ...
    private convert(task: Task): Task {
        ...
        copy.deadline = this.dateUtils
            .convertLocalDateToServer(task.deadline);
        return copy;
    }
}
